document.querySelector("#cv").addEventListener("click", () => {
  document.querySelector(
    "#render"
  ).innerHTML = `   <iframe class="card w-100 vh-100" src="../src/pdf/CV_Tran_Van_Thinh_Web_Developer.pdf" />`;
});
...
function ViewBangDem() {
  ...
  if (pass == null || pass == "" || pass != "1234") {
    ...
    document.querySelector(
      "#render"
    ).innerHTML = `   <iframe class="card w-100 vh-100" src="../src/pdf/bangdem.pdf" />`;
  }
  console.log(text);
}
